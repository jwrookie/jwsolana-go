...
[![GoDoc](https://pkg.go.dev/badge/github.com/jwrookie/jwsolana-go?status.svg)](https://pkg.go.dev/github.com/jwrookie/jwsolana-go@v1.8.4?tab=doc)
[![GitHub tag (latest SemVer pre-release)](https://img.shields.io/github/v/tag/gagliardetto/solana-go?include_prereleases&label=release-tag)](https://github.com/jwrookie/jwsolana-go/releases)
[![Build Status](https://github.com/jwrookie/jwsolana-go/workflows/tests/badge.svg?branch=main)](https://github.com/jwrookie/jwsolana-go/actions?query=branch%3Amain)
[![TODOs](https://badgen.net/https/api.tickgit.com/badgen/github.com/jwrookie/jwsolana-go/main)](https://www.tickgit.com/browse?repo=github.com/jwrookie/jwsolana-go&branch=main)
[![Go Report Card](https://goreportcard.com/badge/github.com/jwrookie/jwsolana-go)](https://goreportcard.com/report/github.com/jwrookie/jwsolana-go)
...
**If you're looking for a SERUM library, you can check out [gagliardetto/serum-go](https://github.com/gagliardetto/serum-go) ([./programs/serum](https://github.com/jwrookie/jwsolana-go/tree/main/programs/serum) is deprecated.**)
...
```bash
$ cd my-project
$ go get github.com/jwrookie/jwsolana-go@v1.8.4
```
...
You can wait for a transaction confirmation using the `github.com/jwrookie/jwsolana-go/rpc/sendAndConfirmTransaction` package tools (for a complete example: [see here](#transfer-sol-from-one-wallet-to-another-wallet))
...
import (
	...
	lookup "github.com/jwrookie/jwsolana-go/programs/address-lookup-table"
...
import (
  ...
  "github.com/jwrookie/jwsolana-go"
  "github.com/jwrookie/jwsolana-go/programs/system"
  "github.com/jwrookie/jwsolana-go/rpc"
...
import (
  ...
  "github.com/jwrookie/jwsolana-go/rpc"
  "github.com/jwrookie/jwsolana-go/rpc/jsonrpc"
)
...
import (
  ...
  "github.com/jwrookie/jwsolana-go/programs/system"
  "github.com/jwrookie/jwsolana-go/rpc"
  confirm "github.com/jwrookie/jwsolana-go/rpc/sendAndConfirmTransaction"
  "github.com/jwrookie/jwsolana-go/rpc/jsonrpc"
  "github.com/jwrookie/jwsolana-go/rpc/ws"
  "github.com/jwrookie/jwsolana-go/text"
)
